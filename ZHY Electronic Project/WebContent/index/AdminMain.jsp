      		...
      		<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="MainLogin.jsp"><i class="glyphicon-log-out"></i>退出</a></li>	
					</ul>
				...
				<div class="col-sm-3 col-md-2 sidebar">		
					<ul class="nav nav-sidebar">
						...
						<ul id="productMeun" class="nav nav-list collapse menu-second">
							<li><a href="###" onclick="showAtRight('xunjian.jsp')"><i class="fa fa-list-alt"></i> 巡检</a></li>
...
<!-- 右侧内容展示==================================================   -->   		
 				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h1 class="page-header"><i class="fa fa-cog fa-spin"></i>&nbsp;控制台<small>&nbsp;&nbsp;&nbsp;ZHY电子化巡检系统后台管理</small></h1>
